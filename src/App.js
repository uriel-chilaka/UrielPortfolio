...
export default function Portfolio() {
  ...
  const experiences = [
    { company:"Memorial University", role:"Co-op Engineering Student", period:"Jan 2026 – Apr 2026", location:"St. John's, NL", description:"Delivered hands-on STEM and engineering workshops to youth through school visits, camps, and community outreach. Introduced fundamental Python programming and engineering principles via Arduino and Raspberry Pi.", logoUrl:"https://www.sciencerendezvous.ca/wp-content/uploads/2017/03/logo-memorial.jpg", logo:"MU", skills:["Python","Leadership","Problem-solving","Project Management"] },
